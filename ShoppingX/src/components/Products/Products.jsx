    ...
    <div className='mt-14 mb-12 '>
        <div className='container'>
            ...
            <div className='text-center mb-10 max-w-[600px] mx-auto'>
                <p data-aos="fade-up" className='text-sm text-orange-200'>Top Selling Products for you</p>
            ...
            <div className='space-x-4'>
                <div className="grid grid-cols-1 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 place-items-center gap-5 mx-20">
                    {/* card-section */}
                    {
                ...
                <div className="flex justify-center">
                    <button className="text-center mt-10 cursor-pointer bg-gradient-to-r from-[#fea928] to-[#ed8900] text-white py-1 px-5 rounded-md">View All Button</button>
                </div>
            </div>
        </div>
    </div>
